    ...
    return (
        <div className={splitClasses}>
            ...
            <SplitItem subtext="Python, Tensorflow, Keras, Pandas" title="Prostate Cancer Detection" 
                ...
                the best architecture." imageFill={imageFill} />
              ...
              <SplitItem subtext="Pytorch, OpenAI Gym, Microsoft Malmo" title="ObstaclesRL" 
                ...
                Experimented with various reinforcement learning algorithms, such as tabular Q, policy gradient, CNN, and DCRN." imageFill={imageFill} />

              <SplitItem subtext="Python, numpy" title="Visions" 
                message="Worked on various imaging projects ranging from generating panoramas to object detection to face-swapping." imageFill={imageFill} />
